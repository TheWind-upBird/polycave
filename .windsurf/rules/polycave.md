...
**Stop**: "stop polycave" / "normal mode".

**Auto-clarity**: drop polycave for security warnings, irreversible actions, multi-step (≥4) sequences. Resume after.

See `.windsurf/skills/polycave/SKILL.md` for full per-language style guides.
