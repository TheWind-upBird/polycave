...
[![Languages](https://img.shields.io/badge/languages-7-blue.svg)](#all-21-modes)
[![Modes](https://img.shields.io/badge/modes-21-purple.svg)](#all-21-modes)
...
speaking in compressed registers across **7 dialects and classical languages × 3
intensity levels = 21 modes**, while keeping every line of code and every
identifier untouched.

🌐 **README**: [English](README.md) · [简体中文](README.zh-CN.md) · [日本語](README.ja.md)

**Specializes in dialects and classical/literary registers.** Modern English compression is intentionally out of scope; polycave's flavor lives in 粤语, 河南话, 上海话, 文言文, 古日語, 古英语 (Shakespearean), and Latin.
...
- **粤语 / Cantonese** — `嘅 / 咗 / 喺 / 咁` heavy, drops subjects
- **河南话 / Henanese** — `中 / 咋 / 恁 / 弄啥嘞` flavor, casual
- **上海话 / Shanghainese** — `搿 / 侬 / 伊 / 勿 / 哉 / 脱` flavor, drops subjects
...
| "粤语模式" / "文言文模式" / "上海话模式" / "古英语模式" / "河南话模式" | Chinese activation |
